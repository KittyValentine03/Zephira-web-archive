...
{
    public class Darkness : ModMenu
    {

        public override string DisplayName => "1st Sentinel of Darkness";

        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("Zephira/Content/MainMenu/blank");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("Zephira/Content/MainMenu/Darkness").Value;
